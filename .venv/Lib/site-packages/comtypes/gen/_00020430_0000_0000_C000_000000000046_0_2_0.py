...
__all__ = [ 'FONTITALIC', 'Gray', 'OLE_OPTEXCLUSIVE',
           'FONTUNDERSCORE', 'OLE_XSIZE_PIXELS',
           'OLE_XSIZE_CONTAINER', 'IPicture', 'LoadPictureConstants',
           'IPictureDisp', 'Checked', 'OLE_CANCELBOOL',
           'OLE_XPOS_HIMETRIC', 'FONTBOLD', 'OLE_YPOS_PIXELS',
           'IFont', 'Picture', 'StdFont', 'OLE_YSIZE_HIMETRIC',
           'Color', 'FONTSTRIKETHROUGH', 'OLE_YPOS_HIMETRIC',
           'FontEvents', 'Unchecked', 'Monochrome', 'VgaColor',
           'OLE_XSIZE_HIMETRIC', 'FONTSIZE', 'OLE_XPOS_PIXELS',
           'OLE_XPOS_CONTAINER', 'IFontEventsDisp',
           'OLE_YPOS_CONTAINER', 'OLE_HANDLE', 'StdPicture', 'Font',
           'Default', 'OLE_YSIZE_PIXELS', 'OLE_COLOR', 'IFontDisp',
           'OLE_YSIZE_CONTAINER', 'OLE_TRISTATE',
